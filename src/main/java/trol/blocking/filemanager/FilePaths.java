...
public class FilePaths {
    ...
    public static String DANSGUARDIAN_LISTS_PATH = "src/main/resources/trol/blocking/filemanager/test/";
//    public static String DANSGUARDIAN_LISTS_PATH = "/etc/dansguardian/lists/";
    ...
    public static String SQUID_CONFIGURE_PATH = "src/main/resources/trol/blocking/filemanager/test/squid.conf";
//    public static String SQUID_CONFIGURE_PATH = "/etc/squid/squid.conf";
    public static String SQUID_HEADER_CONFIGURATION_PATH = "src/main/resources/trol/blocking/filemanager/squidHeader.conf";
    public static String SQUID_FOOTER_CONFIGURATION_PATH = "src/main/resources/trol/blocking/filemanager/squidFooter.conf";
